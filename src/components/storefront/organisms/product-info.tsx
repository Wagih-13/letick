      ...
      <div className="space-y-4">
        ...
        <div className="hidden sm:flex gap-3">
          <Button
            ...
            aria-label={isOutOfStock ? "Out of stock" : isLoading ? "Adding to cart" : "Add to cart"}
          >
            <ShoppingCart className="mr-2 h-5 w-5" />
            {isOutOfStock ? "Out of Stock" : isLoading ? "Adding..." : "Add to Cart"}
          </Button>
          {!isOutOfStock && (
            <Button size="lg" variant="outline" onClick={handleBuyNow} disabled={isBuying} aria-label={isBuying ? "Loading buy now" : "Buy now"}>
