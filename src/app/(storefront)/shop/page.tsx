...
export default function ShopPage() {
  ...
  const totalPages = useMemo(() => {
    if (!data) return 1;
    return Math.max(1, Math.ceil((data.total || 0) / filters.limit));
  }, [data, filters.limit]);
    ...
    <div className="py-8">
      ...
      <div className="flex items-start justify-between mb-3 mt-4 mb-4">
        ...
        <div className="flex items-center  gap-2">
          ...
          <div className="hidden sm:flex items-center gap-1 ml-2 rounded-md border p-1">
            <Button
                ...
                <PaginationContent>
                  <PaginationItem>
                    <PaginationPrevious
                      ...
                      onClick={(e) => {
                        e.preventDefault();
                        if (filters.page > 1) setFilters((prev) => ({ ...prev, page: prev.page - 1 }));
                      }}
                    />
                  </PaginationItem>
                    ...
                    p === "ellipsis" ? (
                      ...
                      <PaginationItem key={p}>
                        <PaginationLink
                          ...
                          onClick={(e) => {
                            e.preventDefault();
                            if (p !== filters.page) setFilters((prev) => ({ ...prev, page: p as number }));
                          }}
                        >
                          {p}
                        </PaginationLink>
                  ...
                  <PaginationItem>
                    <PaginationNext
                      ...
                      className={filters.page >= totalPages ? "pointer-events-none opacity-50" : undefined}
                      onClick={(e) => {
                        e.preventDefault();
                        if (filters.page < totalPages) setFilters((prev) => ({ ...prev, page: prev.page + 1 }));
                      }}
                    />
                  </PaginationItem>
                </PaginationContent>
