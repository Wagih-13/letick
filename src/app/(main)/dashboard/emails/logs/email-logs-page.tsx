    ...
    <div className="@container/main flex flex-col gap-4 md:gap-6">
      <div className="grid grid-cols-1 gap-3 sm:grid-cols-2 xl:grid-cols-8">
        ...
        <div className="rounded-lg border p-4 col-span-1">
          ...
          <div className="text-2xl font-semibold">{Number(metrics?.sentCount ?? 0)}</div>
        </div>
        <div className="rounded-lg border p-4 col-span-1">
          <div className="flex items-center justify-between">
        ...
        <div className="rounded-lg border p-4 col-span-1">
          ...
          <div className="text-2xl font-semibold">{Number(metrics?.bouncedCount ?? 0)}</div>
        </div>
        <div className="rounded-lg border p-4 col-span-1">
          <div className="flex items-center justify-between">
        ...
        <div className="rounded-lg border p-4 col-span-1">
          ...
          <div className="text-2xl font-semibold">{Number(metrics?.distinctRecipients ?? 0)}</div>
        </div>
        <div className="rounded-lg border p-4 col-span-1">
          <div className="flex items-center justify-between">
          ...
          <div className="text-2xl font-semibold">{Number(metrics?.deliveryRate ?? 0)}%</div>
        </div>
      </div>
